...
//Filtramos del array los eventos pasados
const pastEvents = arrayEvents.filter((event) => event.date < currentDate);
...
const arrayCategory = pastEvents.map((event) => event.category); 
